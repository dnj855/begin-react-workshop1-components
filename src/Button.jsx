...
export const buttonVariants = cva(
  "inline-flex items-center justify-center transition-colors cursor-pointer rounded-md px-3 py-1.5 ring-indigo-500 ring-offset-2 focus:outline-none focus-visible:ring",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-gray-200 to-gray-950 hover:bg-gray-300",
      },
    },
    defaultVariants: {
      variant: "default",
